...
import com.example.application.views.myservers.MyServersView;
...
public class MainLayout extends AppLayout {
    ...
    private SideNav createNavigation() {
        ...
        if (accessChecker.hasAccess(MyServersView.class)) {
            nav.addItem(
                    new SideNavItem("My Servers", MyServersView.class, LineAwesomeIcon.PENCIL_RULER_SOLID.create()));
